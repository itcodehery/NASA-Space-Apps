...
import { FiMapPin, FiFilter, FiCalendar, FiLayers, FiGlobe } from 'react-icons/fi';
...
export default function Map({ filters, year }) {
  ...
  const stateData = [
    { stateCode: "TX", stateName: "Texas", CO2: 85, CH4: 45, CO: 25, totalEmissions: 155, x: 300, y: 400 },
    { stateCode: "CA", stateName: "California", CO2: 70, CH4: 35, CO: 20, totalEmissions: 125, x: 100, y: 250 },
    { stateCode: "NY", stateName: "New York", CO2: 55, CH4: 25, CO: 15, totalEmissions: 95, x: 700, y: 180 },
    { stateCode: "FL", stateName: "Florida", CO2: 60, CH4: 30, CO: 18, totalEmissions: 108, x: 680, y: 420 },
    { stateCode: "PA", stateName: "Pennsylvania", CO2: 75, CH4: 40, CO: 22, totalEmissions: 137, x: 650, y: 220 },
    { stateCode: "IL", stateName: "Illinois", CO2: 65, CH4: 35, CO: 20, totalEmissions: 120, x: 500, y: 280 },
    { stateCode: "AL", stateName: "Alabama", CO2: 50, CH4: 25, CO: 15, totalEmissions: 90, x: 550, y: 380 }
  ];
  ...
  return (
    <div className="map-wrap">
          ...
          >
            <g transform="translate(80, 50) scale(0.9)">
              {stateData.map((state) => {
                ...
                const stateShapes = {
                  TX: { path: "M 250 350 L 400 350 L 400 450 L 250 450 Z", x: 325, y: 400 },
                  CA: { path: "M 50 150 L 150 150 L 150 300 L 50 300 Z", x: 100, y: 225 },
                  NY: { path: "M 600 100 L 700 100 L 700 180 L 600 180 Z", x: 650, y: 140 },
                  FL: { path: "M 650 400 L 750 400 L 750 500 L 650 500 Z", x: 700, y: 450 },
                  PA: { path: "M 580 160 L 680 160 L 680 220 L 580 220 Z", x: 630, y: 190 },
                  IL: { path: "M 400 220 L 500 220 L 500 300 L 400 300 Z", x: 450, y: 260 },
                  AL: { path: "M 500 350 L 600 350 L 600 420 L 500 420 Z", x: 550, y: 385 }
                };
      ...
      <div className="absolute top-4 left-4 bg-gray-900/95 border border-gray-700 p-4 z-10">
        ...
        <div className="mb-3">
          <button
            onClick={() => setMapMode(mapMode === 'coordinates' ? 'states' : 'coordinates')}
